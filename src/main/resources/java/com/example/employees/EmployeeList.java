...
public class EmployeeList {
	...
	static {
		...
		employeeList.add(new Employee("Peter","Willians","22-10-1966","Coordinator","HR", "peter.willians@abc.com"));
		...
		employeeList.add(new Employee("Samuel","Willians","22-03-1985","Coordinator","Finance", "samuel.willians@abc.com"));
	}
